...
namespace BulkyBook.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        [BindProperty]
        public InputModel Input { get; set; } // Koristi se unutar view-a
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var result = await _userManager.CreateAsync(user, Input.Password); // Stvara User-a
                if (result.Succeeded)
                {
                    ...
                    //await _userManager.AddToRoleAsync(user, SD.Role_Admin); Prije

                    if (user.Role == null) // Nije odabrana rola ==> Individualni user
                    {
                    ...
                    {
                        if (user.Role == null) // znaci da se korisnik sam registrira
                        {
